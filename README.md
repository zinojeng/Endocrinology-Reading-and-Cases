# Endocrinology Reading & Cases — Tungs' Hospital

內分泌新陳代謝科的**讀書與病例討論**彙整：Williams Textbook 章節精讀、專科考試準備（FellowCamp），以及國際會議（ENDO）的 case 解析與 Meet-the-Professor 雙語整理。

內容以繁體中文解說 + 保留英文專有名詞為原則；忠於原文、數字不外推，臨床決策請以最新指引與原文為準。

## 📚 三大類別 Categories

| 類別 | 說明 | 連結 |
|------|------|------|
| 📖 **Williams Textbook** | Williams Textbook of Endocrinology 各章節的 fellow 精讀筆記（條列、中英對照、記憶法／比較表） | [**Williams-Textbook/**](Williams-Textbook/) |
| 🏕️ **FellowCamp** | 內分泌新陳代謝科**專科考試準備**：如何準備、各腺體重點、臨床試驗與動態試驗 | [**FellowCamp/**](FellowCamp/) |
| 🌏 **Conferences** | **國際會議**（ENDO）case 解析、案例分析與 Meet-the-Professor 雙語資料 | [**Conferences/**](Conferences/) |
...
內分泌新陳代謝科專科醫師訓練課程的考試重點整理。→ [**FellowCamp/2026/**](FellowCamp/2026/)（115 年度：00 準讀策略總綱 → 01–02 糖尿病／內分泌兩科深度重點 → 03–11 各腺體場次）。
