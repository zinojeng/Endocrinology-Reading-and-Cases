...
> [**FellowCamp-2026/**](FellowCamp-2026/) — 115 年度內分泌新陳代謝科專科醫師訓練課程重點整理（給 2026 輔導員與考生），由各場次**投影片**經 LlamaParse 解析後整理為考試重點。
>
> 依 **00 → 11** 順序：**00** 準讀版策略總綱（如何準備考試）→ **01–02** 糖尿病／內分泌兩科深度重點 → **03–11** 各腺體場次（臨床試驗、動態試驗、骨骼、腦垂體、甲狀腺孕期、副甲狀腺、腎上腺、胰腺、生殖內分泌）。原始投影片解析與兩科 PDF 集中在 [`_source/`](FellowCamp-2026/_source/)。
