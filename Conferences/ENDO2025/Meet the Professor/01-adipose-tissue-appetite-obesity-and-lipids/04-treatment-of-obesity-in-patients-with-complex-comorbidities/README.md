# Treatment of Obesity in Patients With Complex Comorbidities

> **中文標題**：合併複雜共病患者的 obesity 治療
> **分類 Category**：Adipose Tissue, Appetite, Obesity, and Lipids
> **Case number**：4
> **Faculty**：Tirissa J. Reid, MD, DABOM
...
- 辨識 `Treatment of Obesity in Patients With Complex Comorbidities` 相關 case 的核心臨床問題與常見表現。
- 建立初步鑑別診斷、必要檢查與危險訊號的排序。
- 理解治療選項、追蹤策略與病人溝通重點。

## 臨床學習摘要

複雜共病下的 obesity care 需要兼顧 cardiovascular disease、CKD、liver disease、psychiatric illness、藥物交互作用與可近性。學習重點是以 shared decision-making 排列治療優先順序，並在安全監測中調整藥物與轉介 bariatric/metabolic surgery。
...
1. 這個 case 中，哪些病史或檢查結果最能改變 `Treatment of Obesity in Patients With Complex Comorbidities` 的診斷機率？
