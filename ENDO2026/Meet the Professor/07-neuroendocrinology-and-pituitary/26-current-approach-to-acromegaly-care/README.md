...
> 📊 圖：Case 1 病人之 pituitary MRI，顯示具鞍上延伸的大型 macroadenoma（原書 Figure 2）。

> 📊 圖：Case 2 病人診斷時之 pituitary MRI，顯示 3 × 2 × 2 cm、侵犯左側 cavernous sinus 的 macroadenoma（原書 Figure 3）。

> 📊 圖：Case 3 病人之 pituitary MRI，顯示大型、侵襲性、延伸至左側 cavernous sinus 並壓迫 optic chiasm 的 macroadenoma（原書 Figure 5）。
...
> 📊 圖：Pituitary Society acromegaly consensus 之當代治療策略流程（原書 Figure 1；改繪自 Melmed S et al. *Nat Rev Endocrinol.* 2025;21(11):718-37）。
