...
> 📊 圖 1：Melanocortin-4-Receptor Pathway（MC4R 路徑示意圖）— 呈現 POMC／α-/β-MSH、AgRP、LEPR、serotonin receptor 2C 對 MC4R 的調控關係（原書 Figure 1）。
...
> 📊 圖 4：病人基因檢測報告顯示 *LEPR* 基因的致病性變異（pathogenic variant）（原書 Figure 4）。
